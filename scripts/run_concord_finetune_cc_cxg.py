# Reference: https://github.com/microsoft/CodeXGLUE/tree/main/Code-Code/Clone-detection-POJ-104/code
...
from concord.modeling_concord import ConcordForEncoder
...
def main():
    ...
    parser.add_argument('--warmup_ratio', type=float, default=0,
                        help="warm up ratio")
    parser.add_argument("--new_pooler", action='store_true', help="Whether use new pooler for finetuning")
    ...
    model = ConcordForEncoder.from_pretrained(args.model_name_or_path, config=config, new_pooler=args.new_pooler if args.new_pooler else None)
